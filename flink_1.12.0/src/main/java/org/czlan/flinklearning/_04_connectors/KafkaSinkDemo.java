 ...
 * @description Flink-Connectors-KafkaConsumer/Source + KafkaProducer/Sink
 *
 * 建议设置的项：
 * 1. 订阅的主题
 * 2. 反序列化规则
...
public class KafkaSinkDemo {
    public static void main(String[] args) throws Exception {
        ...
        FlinkKafkaProducer<String> kafkaSlink = new FlinkKafkaProducer<>("flink_kafka2", new SimpleStringSchema(), props2);
        etlDS.addSink(kafkaSlink);
