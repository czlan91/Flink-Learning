 ...
 * @description 使用事件时间+watermaker+window 完成订单统计  table风格
...
public class Demo03_2 {
    public static void main(String[] args) throws Exception {
        ...
        // Table table = bsTableEnv.fromDataStream(orderDSWithWatermark, $("orderId"), $("userId"), $("money"), $("createTime").rowtime());
        // table.groupBy().select();

        Table resultTable = bsTableEnv.from("t_order")
